...
ms.version.addpkg('pyparsing', '2.0.3')
...
ms.version.addpkg('wxPython', '4.0.1')
ms.version.addpkg('scipy', '1.0.0')
ms.version.addpkg('scikits.learn', '0.19.1')
...
bools_str = np.char.mod('%d', bools)
# decisions_str = np.char.mod('%f', decisions)
# print( bools_str, decisions_str)
# # line = sys.stdin.readline()
# # print(line)
# # print(','.join(bools_str))
# # print(','.join(decisions_str))
# i = 0
# while True:
#     line = sys.stdin.readline()
#     # print(line)
